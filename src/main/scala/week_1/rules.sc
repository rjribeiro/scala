...
val card1 = Card(Shape.Diamond, NumberOfShapes.OneShape, Shading.Striped, Color.Blue)
val card2 = Card(Shape.Squiggle, NumberOfShapes.TwoShapes, Shading.Open, Color.Red)
val card3 = Card(Shape.Oval, NumberOfShapes.ThreeShapes, Shading.Solid, Color.Green)
val card4 = Card(Shape.Oval, NumberOfShapes.TwoShapes, Shading.Solid, Color.Green)
