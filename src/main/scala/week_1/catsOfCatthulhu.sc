/* Pergunta 1
In the game "Cats of Catthulhu" a cat is described by: a Name; a Role; a Background; and a Description.
...
Background consists of: a Lifestyle, which is one of Feral, Housecat, or Showcat;

a description of Hunting experience, which is free text;
and any other text that is relevant.
